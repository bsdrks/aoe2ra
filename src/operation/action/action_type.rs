...
impl From<u8> for ActionType {
    fn from(value: u8) -> Self {
        match value {
            ...
            0x23 => Self::Action0x23,
            0x25 => Self::Action0x25,
            0x26 => Self::DeAutoScout,
            0x29 => Self::Action0x29,
            0x2c => Self::Action0x2c,
            0x2d => Self::Action0x2d,
            0x35 => Self::AiCommand,
            0x64 => Self::AiQueue,
            0x65 => Self::Research,
            0x66 => Self::Build,
            ...
            0x81 => Self::DeQueue,
            0x82 => Self::Action0x82,
            0x83 => Self::Action0x83,
            0x8c => Self::Action0x8c,
            0xc4 => Self::Action0xc4,
            0xff => Self::PostGame,
